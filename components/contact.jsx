export default function Contact() {
  /* 
    "Book your next photoshoot with our experienced photographer for stunning memories that last a lifetime. Contact us today!"
    */

  const bookingMessage =
    "Hi there! I'd like to book your photography services for an event on [Date]. Are you available? Thanks!";
